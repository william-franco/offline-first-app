...
// in offline_first_app/test/features/users/user_mocks.dart.
...
/// A class which mocks [UserLocalService].
///
/// See the documentation for Mockito's code generation for more information.
class MockUserLocalService extends _i1.Mock implements _i5.UserLocalService {
  MockUserLocalService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<void> saveUsers(List<_i6.UserModel>? users) => (super.noSuchMethod(
  ...
  @override
  _i3.Future<void> clearUsers() => (super.noSuchMethod(
    Invocation.method(#clearUsers, []),
    returnValue: _i3.Future<void>.value(),
    returnValueForMissingStub: _i3.Future<void>.value(),
  ) as _i3.Future<void>);
}
...
class MockUserRepository extends _i1.Mock implements _i7.UserRepository {
  ...
  @override
  _i3.Future<_i8.ResultPattern<List<_i6.UserModel>, _i9.UserException>>
  findAllUsers() => (super.noSuchMethod(
    Invocation.method(#findAllUsers, []),
    returnValue:
        _i3.Future<
          _i8.ResultPattern<List<_i6.UserModel>, _i9.UserException>
        >.value(
          _i10.dummyValue<
            _i8.ResultPattern<List<_i6.UserModel>, _i9.UserException>
          >(this, Invocation.method(#findAllUsers, [])),
        ),
  ) as _i3.Future<_i8.ResultPattern<List<_i6.UserModel>, _i9.UserException>>);
}
